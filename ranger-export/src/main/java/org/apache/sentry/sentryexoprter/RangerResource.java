...
public class RangerResource extends RangerAccessResourceImpl {
  ...
  private ServiceConstants.HiveObjectType objectType = null;

  public RangerResource(ServiceConstants.HiveObjectType objectType, String databaseorUrl) {
    this(objectType, databaseorUrl, null, null);
  }

  public RangerResource(ServiceConstants.HiveObjectType objectType, String databaseorUrl, String tableOrUdf) {
    this(objectType, databaseorUrl, tableOrUdf, null);
  }

  public RangerResource(ServiceConstants.HiveObjectType objectType, String databaseorUrl, String tableOrUdf, String column) {
  ...
  public ServiceConstants.HiveObjectType getObjectType() {
    return objectType;
  }
